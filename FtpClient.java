...
public class FtpClient {
     ...
     * @param username: the username you use to log in to your FTP session
    ...
    public void getFile(String file_name) {
        ...
        try {
            ...
            controlSocket = new Socket("localhost", data_port);
            DataInputStream data_reader = new DataInputStream(controlSocket.getInputStream());
            // download file from ftp server
            sendCommand("RETR " + file_name + CRLF, 150);
            // check if the transfer was succesful
            sendCommand("STAT " + CRLF, 213);
